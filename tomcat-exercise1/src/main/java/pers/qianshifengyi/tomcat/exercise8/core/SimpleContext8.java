 ...
 */
public class SimpleContext8 implements Context,Pipeline,Lifecycle{

    private Pipeline pipeline = new SimplePipeline8();
    ...
    public void start() throws LifecycleException {
        if(started == true){
            throw new LifecycleException("SimpleContext8 has been started !");
        }
        ...
        if(children != null){
            synchronized (children){
                for(Container containerTemp:children.values()){
    ...
    public String[] findServletMappings() {
        return (String[])servletMappings.values().toArray();
    }
